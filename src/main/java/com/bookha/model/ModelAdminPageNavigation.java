...
public class ModelAdminPageNavigation {
	public ModelAdminPageNavigation() {
		// TODO Auto-generated constructor stub
	}
	
	public String getPageNav(DTOAdminTotal dto) {
		String model = "";
