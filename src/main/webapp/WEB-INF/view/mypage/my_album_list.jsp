...
<body>
		...
		<div class="layout-container">
			...
			<aside id="layout-menu"
				...
				<ul class="menu-inner py-1">
					...
					<!-- Tables -->
					<li class="menu-item"><a href="achievement.do"
					...
					<li class="menu-item active" style=""><a href="javascript:void(0)"
						...
						<ul class="menu-sub">
							...
							<li class="menu-item active"><a href="/al_list.do" class="menu-link">
					...
					<!-- Tables -->
					<li class="menu-item"><a href="/user_account_setting"
						class="menu-link"> <i class='menu-icon bx bx-book-open'
							style='color: #646363'></i> <!-- <i class='menu-icon bx bx-book-open' style='color:#646363'  ></i> -->
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">내 글 모아보기 ></span> 앨범 게시판
						</h4>
	...
	<div class="buy-now">
		<a href="./album_list.do" class="btn btn-outline-primary btn-buy-now">게시판 이동</a>
	</div>
