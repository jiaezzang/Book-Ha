		...
		<div class="layout-container">
			...
			<aside id="layout-menu"
				...
				<div class="app-brand demo">
					<a href="/home.do" class="app-brand-link"> <!--  로고 이미지  --> <img
						...
						<div class="card">
							...
							<div class="table-responsive text-nowrap">
								<table class="table table-borderless">
									...
									<tbody>
										<tr>
											<td>&nbsp;&nbsp; <input type="radio" class="btn-check"
												name="btnradio" <%=btnradio1%> id="btnradio1"
												autocomplete="off"> <label
												class="btn rounded-pill btn-outline-primary" for="btnradio1">#
													나눔</label> &nbsp; <input type="radio" class="btn-check"
												name="btnradio" <%=btnradio2%> id="btnradio2"
												autocomplete="off"> <label
												class="btn rounded-pill btn-outline-primary" for="btnradio2">#
													교환</label> &nbsp; <input type="radio" class="btn-check"
												name="btnradio" <%=btnradio3%> id="btnradio3"
												autocomplete="off"> <label
												class="btn rounded-pill btn-outline-primary" for="btnradio3">#
													빌려줌</label> &nbsp; <input type="radio" class="btn-check"
												name="btnradio" <%=btnradio4%> id="btnradio4"
												autocomplete="off"> <label
												class="btn rounded-pill btn-outline-primary" for="btnradio4">#
													빌려줘</label>
											</td>
											<td align="right"><label><%=date%>  |  <%=hit%>
													&nbsp;&nbsp;</label></td>
										</tr>
									</tbody>
								</table>
							...
							<div class="list-group" id="profile_group">
								...
								<label class='list-group-item'>
									<div class='d-grid d-sm-flex p-3'>
										<img src='<%=myprofile %>' style='width: 120px'
						...
						<div class="card">
							...
							<div class="input-group">
								<textarea class="form-control" aria-label="With textarea"
									id="reply-text-area" placeholder="댓글을 입력해 주세요"></textarea>
