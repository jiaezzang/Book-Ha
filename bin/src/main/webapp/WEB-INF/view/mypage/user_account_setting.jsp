									...
									<div class="card-body">
										<form id="formAccountSettings" method="POST"
											...
											<div class="row">
												...
												<div class="mb-3 col-md-6">
													<label for="lastName" class="form-label">이 름</label> <input
														class="form-control" type="text" name="lastName"
														id="lastName" value="이 름" />
												</div>
												<div class="mb-3 col-md-6">
													<label for="email" class="form-label">닉네임</label> <input
														class="form-control" type="text" id="email" name="email"
														value="닉 네 임" placeholder="john.doe@example.com" />
												</div>
												<div class="mb-3 col-md-6">
													<label for="organization" class="form-label">연 락 처</label>
													<input type="text" class="form-control" id="organization"
														name="organization" value="연 락 처" />
												</div>
												<div class="mb-3 col-md-6">
													<label class="form-label" for="phoneNumber">자 기 소 개</label>
													<div class="input-group input-group-merge">
														<input type="text" id="phoneNumber" name="phoneNumber"
															class="form-control" value="자기소개" />
													</div>
												</div>
												<div class="mt-2">
													<button type="submit" class="btn btn-primary me-2">변
														경 사 항 저 장</button>
													<button type="reset" class="btn btn-outline-secondary">취
														소</button>
												</div>
										</form>
									</div>
									...
									<div class="card-body">
										...
										<form id="formAccountDeactivation" onsubmit="return false">
											<div class="form-check mb-3">
												...
												<label class="form-check-label" for="accountActivation">계정
													삭제에 동의합니다.</label>
											</div>
											<button type="submit"
												class="btn btn-danger deactivate-account">계 정 삭 제</button>
										</form>
									</div>
								</div>
							</div>
