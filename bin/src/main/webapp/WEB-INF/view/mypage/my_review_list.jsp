...
<body>
			...
			<aside id="layout-menu"
				...
				<ul class="menu-inner py-1">
					...
					<li class="menu-item active" style=""><a href="javascript:void(0)"
						...
						<ul class="menu-sub">
							<li class="menu-item active"><a href="/re_list.do"
								class="menu-link">
				...
				<div class="content-wrapper">
					...
					<div class="container-xxl flex-grow-1 container-p-y">
						<h4 class="fw-bold py-3 mb-4">
							<span class="text-muted fw-light">내 글 모아보기 ></span> 리뷰 게시판
						</h4>
									...
									<tbody class="table-border-bottom-0">
										<tr>
											<td><i class="fab fa-angular fa-lg text-danger me-2"></i>
												<a href="./re_view.do" style="color: gray"> <strong>[책
	...
	<div class="buy-now">
		<a href="./review_list.do" class="btn btn-outline-primary btn-buy-now">게시판 이동</a>
	</div>
